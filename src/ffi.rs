...
bitflags! {
    struct I2CFunctions: u32 {
        ...
        const I2C_FUNC_PROTOCOL_MANGLING = 0x00000004; /* I2CMsgFlags::I2C_M_IGNORE_NAK etc. */
        const I2C_FUNC_SMBUS_PEC = 0x00000008;
        const I2C_FUNC_NOSTART = 0x00000010; /* I2CMsgFlags::I2C_M_NOSTART */
...
ioctl!(bad readwrite ioctl_set_i2c_slave_address with I2C_SLAVE; u8);
ioctl!(bad readwrite ioctl_i2c_smbus with I2C_SMBUS; u8);
